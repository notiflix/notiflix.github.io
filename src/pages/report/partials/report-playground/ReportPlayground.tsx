...
function ReportPlayground(): JSX.Element {
  ...
  return (
    <div className={styles.report__playground}>

      <div className={styles.report__playground__head}>
        <h2 className={styles.report__playground__head__title}>{_dbReportPlayground?.title}</h2>
        <button
          aria-label={constants.app.text.switch}
          onClick={() => switchAsAModuleOnClickHandler(!stateReportIsModule)}
          className={[
            `${styles.report__playground__head__switch}`,
            `${styles[`report__playground__head__switch--${stateReportIsModule ? 'module' : 'global'}`] || ''}`,
          ].join(' ').trim()}
        >
          <span className={styles.report__playground__head__switch__text}>{stateReportIsModule ? constants.app.text.module : constants.app.text.global}</span>
        </button>
      </div>
      ...
      <div className={styles.report__playground__list}>
            ...
            return (
              ...
              >
                <div className={styles.report__playground__list__item__content}>
                  ...
                  <div className={styles.report__playground__list__item__head}>
                    <h3
                      className={[
                  ...
                  <div className={styles.report__playground__list__item__usage}>

                    <div className={styles.report__playground__list__item__usage__code}>
                    ...
                    <div className={styles.report__playground__list__item__usage__preview}>
                      <IconArrowDown className={styles.report__playground__list__item__usage__preview__arrow} />
                      ...
                      >
                        ...
                        <LazyImage
                          threshold={0.25}
                          className={styles.report__playground__list__item__usage__preview__item__icon}
                  ...
                  <div className={styles.report__playground__list__item__demo}>

                    <div className={styles.report__playground__list__item__demo__head}>
                      <h4 className={styles.report__playground__list__item__demo__head__title}>{_dbReportPlayground.demoInfoTitle}</h4>
                      <p className={styles.report__playground__list__item__demo__head__description}>{_dbReportPlayground.demoInfoDescription}</p>
                    </div>

                    <div className={styles.report__playground__list__item__demo__code}>
                      <code className="code code--medium">
                        <span className="code__lvl1 code__lvl--pb0">
                          {!stateReportIsModule && <><span className="code__namespace">{namespaceGlobal}</span><span>{`.`}</span></>}
                          <span className="code__namespace">{namespaceModule}</span>
        ...
        <div
          className={[
            `${styles.report__playground__list__item}`,
            `${styles[`report__playground__list__item--callback`] || ''}`,
          ].join(' ').trim()}
        >
          <div className={styles.report__playground__list__item__content}>
            <div className={styles.report__playground__list__item__head}>
              <h3 className={styles.report__playground__list__item__head__title}>{_dbReportPlayground?.callbackInfoTitle}</h3>
              <p className={styles.report__playground__list__item__head__description}>{_dbReportPlayground?.callbackInfoDescription}</p>
            </div>
        ...
        <div
          className={[
            `${styles.report__playground__list__item}`,
            `${styles[`report__playground__list__item--extend`] || ''}`,
          ].join(' ').trim()}
        >
          <div className={styles.report__playground__list__item__content}>
            <div className={styles.report__playground__list__item__head}>
              <h3 className={styles.report__playground__list__item__head__title}>{_dbReportPlayground?.extendInfoTitle}</h3>
              <p className={styles.report__playground__list__item__head__description}>{_dbReportPlayground?.extendInfoDescription}</p>
